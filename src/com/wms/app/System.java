...
public class System {
	...
	java.lang.System.out.println("*******欢迎来到仓库管理系统*******");
	java.lang.System.out.println("**********1.录入商品**********");
	java.lang.System.out.println("**********2.展示所有商品**********");
	java.lang.System.out.println("**********3.删除商品*******");
	java.lang.System.out.println("**********4.修改商品**********");
	java.lang.System.out.println("**********5.模糊搜索**********");
	java.lang.System.out.println("**********7.退出系统**********");
	java.lang.System.out.print("请按1~7进行相关操作");
	}
	public static void modifyMenu() {
		java.lang.System.out.println("******修改界面*******");
		java.lang.System.out.println("******1.修改价格 *******");
		java.lang.System.out.println("******2.修改编号 *******");
		java.lang.System.out.println("请按1~2进行相关操作");
	}
	public static void loginMenu() {
		java.lang.System.out.println("******隆中超市管理系统*******");
		java.lang.System.out.println("******请先登录*******");	
		login();
	}
	public static void login(){
		java.lang.System.out.println("请输入用户名：");
		Scanner in=new Scanner(java.lang.System.in);
		String username=in.next();
		java.lang.System.out.println("请输入密码：");
		String  password=in.next();
//		in.close();
		if(username.equals("Tom")&&password.equals("123"))
		{
			java.lang.System.out.println("登陆成功！");
			mainMenu();
		}
		else{			
			if(count >=1){
				java.lang.System.out.println("对不起！亲，您已经没有机会了！");
				return;
			}else{
				count++;
				java.lang.System.out.println("对不起，你输入的用户名或密码错误！请重新输入！");
				login();
			}			
		}
}
	public static void addGood() {//添加商品
		...
		do {
		Scanner in=new Scanner(java.lang.System.in);
		java.lang.System.out.println("请输入添加的商品名称");
		String name=in.next();
		java.lang.System.out.println("请输入添加的商品价格");
		String price=in.next();
		java.lang.System.out.println("请输入添加的商品编码");
...
//		in.close();
		...
		good[n][2]=amount;
		n++;
		java.lang.System.out.println("是否继续添加？输入Y/y或N/n");
		judge=in.next();
		...
		public static void showGoods() {//展示所有商品,分页显示
			...
			do {
			java.lang.System.out.println("*****第"+page+"页******");
			java.lang.System.out.println("名称\t 价格\t 编码\t");
			for(int k=i;k<n;k++) {
				for(int j=0;j<3;j++) {
					java.lang.System.out.print(good[k][j]+"\t");
				}
